...
ete3 evol -t ${GENEDIR}/${gene}/${gene}.raxml.bestTree --alg ${GENEDIR}/${gene}/${gene}_align_DNA_trimmed.fasta --codeml_param CodonFreq,3 ncatG,4 verbose,0 --models M0 M8 M8a --cpu 3 --tests M8,M8a -o ${GENEDIR}/${gene}/paml --clear_all > ${GENEDIR}/${gene}/${gene}_paml.out
